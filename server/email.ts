  ...
  const html = `
    <div style="font-family: 'Inter', 'Segoe UI', sans-serif; max-width: 680px; margin: 0 auto; background: hsl(210, 15%, 12%); border-radius: 0; overflow: hidden;">
        ...
        <div style="background: hsl(210, 12%, 25%); padding: 40px 35px; margin: 45px 0; border: 1px solid hsl(45, 65%, 75%); border-width: 1px 0;">
          ...
          <a href="https://bourarro.lodgify.com/" 
             style="font-family: 'Inter', sans-serif;
                    ...
                    border: 1px solid hsl(45, 65%, 75%);">
            View Portfolio
          </a>
        </div>
        
        <!-- Elite Investment Circle -->
      ...
      <div style="background: hsl(210, 20%, 8%); padding: 50px 45px; border-top: 2px solid hsl(45, 65%, 75%);">
        ...
        <div style="text-align: center; margin-bottom: 35px;">
          <p style="font-family: 'Inter', sans-serif; color: hsl(210, 8%, 75%); font-size: 16px; line-height: 1.4; margin: 0 0 10px 0; font-weight: 400;">
            Sincerely,
          </p>
          <p style="font-family: 'Playfair Display', Georgia, serif; color: hsl(45, 65%, 75%); font-size: 24px; line-height: 1.3; margin: 0; font-weight: 500; letter-spacing: -0.3px;">
          ...
          <table style="margin: 0 auto; border-collapse: collapse; border-spacing: 0;">
            <tr>
              <td style="padding: 10px 0; text-align: center;">
                <p style="font-family: 'Inter', sans-serif; color: hsl(210, 8%, 75%); font-size: 14px; margin: 0; font-weight: 400; letter-spacing: 0.5px;">
                  <a href="mailto:info@bourarroproperties.co.uk" style="color: hsl(45, 65%, 75%); text-decoration: none; font-weight: 500;">info@bourarroproperties.co.uk</a>
                </p>
              </td>
            </tr>
            <tr>
              <td style="padding: 10px 0; text-align: center;">
                <p style="font-family: 'Inter', sans-serif; color: hsl(210, 8%, 75%); font-size: 14px; margin: 0; font-weight: 400; letter-spacing: 0.5px;">
                  <a href="https://bourarroproperties.uk" style="color: hsl(210, 8%, 85%); text-decoration: none; font-weight: 500;">bourarroproperties.uk</a>
                </p>
              </td>
            </tr>
          </table>
        ...
        <div style="text-align: center; margin-top: 35px; padding-top: 25px; border-top: 1px solid hsl(210, 12%, 25%);">
          <p style="font-family: 'Playfair Display', Georgia, serif; color: hsl(210, 8%, 65%); font-size: 14px; margin: 0; font-weight: 400; font-style: italic; letter-spacing: 0.3px;">
            Exclusive Property Investment Solutions
          </p>
        </div>
      </div>
