  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Contact Bourarro Properties for a free property management quote. Get in touch for guaranteed rent services, property maintenance, or investment opportunities. Phone: +44 7435 549937"
